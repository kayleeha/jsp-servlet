						...
						<tbody>
							<tr>
								...
								<td class="text-align-left text-indent text-strong text-orange"
									colspan="3">${n.title}</td> <!-- rs.getString("TITLE")이었던 걸 mvc model 사용 후 간단해짐 -->
									<!-- request.getAttribute("title") -->
									<!-- n.title (EL)을 사용함으로써 코드 블럭()이 필요 없어졌다. -->
							</tr>
							<tr>
								<th>작성일</th>
								<td class="text-align-left text-indent" colspan="3"><td><fmt:formatDate pattern="yy-MM-dd hh:mm:ss" value="${n.regDate}"/> </td></td>
							</tr>
							<tr>
								<th>작성자</th>
								<td>${n.writerId}</td>
